...
1. Каждое слагаемое увеличивается:
...
2. В конец добавлено положительное слагаемое:
...
2. $\sqrt[n]{a_{1}a_{2}a_{3}\dots a_{n}  }\leq \frac{a_{1}+a_{2}+\dots+a_{n}}{n} \quad \forall a_{j}>0 \ \text{"="} \Leftrightarrow a_{1}=a_{2}=a_{3}=\dots=a_{n}$
