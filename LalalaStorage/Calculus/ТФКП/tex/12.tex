...
\textbf{Итого:} \(dw\) есть композиция поворота на угол \(\varphi\)
\(+\) растяжение с коэффициентом \(|f'(z_{0})|\).

\pandocbounded{\includegraphics[keepaspectratio]{Вопросы/media/Pasted image 20260605234927.png}}
...
\(\theta\) --- угол наклона \(l'\), \(\varphi\) --- угол наклона \(l\)
(на рисунке), откуда \(\arg f'(z_0) = \theta - \varphi\).
