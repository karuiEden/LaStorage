...
функции \(f(z)\), если \(\exists \lim_{ z \to a }f(z)=A\in \mathbb{C}\)
(в частности,
\(a=\infty \ \exists \lim_{ z \to \infty }f(z)=A\in \mathbb{C}\))
...
\item
  \(\exists \lim_{ z \to a }(z-a)^{m}\cdot f(z)=B\in \mathbb{C}\) (в
  частности, \(a=\infty\), то 1.
  \(\exists \lim_{ z \to \infty }f(z)=\infty,\) 2.
  \(\exists \lim_{ z \to \infty } \dfrac{f(z)}{z^{m}}=B\in \mathbb{C}\))
\end{enumerate}
